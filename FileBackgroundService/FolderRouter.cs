...
namespace FileBackgroundService
{
    class FolderRouter
    {
        ...
        private static void OnChanged(object source, FileSystemEventArgs e) { FolderUpdate(); }
        private static void OnRenamed(object source, RenamedEventArgs e) { FolderUpdate(); }
